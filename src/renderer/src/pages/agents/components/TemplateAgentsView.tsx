...
import ImportAgentPopup from './ImportAgentPopup'

interface Props {
  onSwitchToWorkbench: () => void
}

const TemplateAgentsView: FC<Props> = ({ onSwitchToWorkbench }) => {
      ...
      <Navbar>
        <NavbarCenter style={{ borderRight: 'none', justifyContent: 'space-between' }}>
          <Flex align="center" gap={8}>
            <Button type="text" size="small" icon={<ArrowLeft size={16} />} onClick={onSwitchToWorkbench} />
            {t('agents.title')} - 模板助手
          </Flex>
          <Input
...
export default TemplateAgentsView
