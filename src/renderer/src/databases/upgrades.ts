...
export async function upgradeToV9(): Promise<void> {
  logger.info('DB migration to version 9 started: Adding packages table for TGZ Package Management')
  ...
  logger.info('DB migration to version 9 finished successfully.')
}
